...
import {FaFacebook, FaGit, FaGithub, FaTiktok, FaTwitter } from 'react-icons/fa';
...
const Final = () => {
  ...
  return (
    ...
    <footer class="rounded-div mt-8 pt-8 text-primary border-b">
    <div class=" px-4 py-16 mx-auto space-y-12 sm:px-6 lg:px-8">
      <div class="sm:items-center sm:justify-between sm:flex">
           ...
           <div class="flex mt-8 space-x-6 text-gray-500 sm:mt-0">
             <a class="hover:opacity-75"  target="_blank" rel="noreferrer">
              ...
              <a class="hover:opacity-75" href="https://github.com/eme-eleuce" target="_blank" rel="noreferrer">
      ...
      <div class="grid grid-cols-1 gap-8 pt-12 border-t  sm:grid-cols-2 lg:grid-cols-4">
        <div>
          <p class="font-bold">
            Company
          </p>
      ...
      <p class="text-xs text-gray-500">&copy; 2022 </p>
    </div>
  </footer>
);
